...
<section id="projects" class="section-block section-block--tight" data-animate aria-labelledby="projects-heading">
  ...
  <div class="project-grid">
    ...
    <a class="project-card" href="https://github.com/Eligoze75/Amazon_InsightCart/tree/master" target="_blank" rel="noopener noreferrer">
      <div class="project-card__row">
        <img class="project-card__logo" src="img/Amazon_InsightCart.png" alt="" width="64" height="64" loading="lazy" decoding="async" />
        <div class="project-card__head">
          <h3 class="project-card__title">Amazon_InsightCart</h3>
          <p class="project-card__meta"><span class="project-card__tag">RAG</span><span class="project-card__dot" aria-hidden="true">·</span><span>Streamlit · Python</span></p>
        </div>
      </div>
      <p class="project-card__desc">Amazon product search assistant over products and reviews: query expansion, hybrid BM25 and FAISS retrieval with RRF, cross-encoder re-ranking, and a grounded LLM answer — all in a Streamlit app.</p>
      <span class="project-card__cta">View on GitHub <span aria-hidden="true">→</span></span>
    </a>
    <a class="project-card" href="https://github.com/Eligoze75/AiEO-Visibility-Challenge/tree/master" target="_blank" rel="noopener noreferrer">
      <div class="project-card__row">
        <img class="project-card__logo" src="img/Aeio_visibility_challenge.png" alt="" width="64" height="64" loading="lazy" decoding="async" />
        <div class="project-card__head">
          <h3 class="project-card__title">AiEO-Visibility-Challenge</h3>
          <p class="project-card__meta"><span class="project-card__tag">Team</span><span class="project-card__dot" aria-hidden="true">·</span><span>RAG evals · Python</span></p>
        </div>
      </div>
      <p class="project-card__desc">Evaluates whether GPT, Gemini, and Claude give accurate, grounded answers on Canadian life and business. Three models answer in parallel with persona prompts; a scoring model uses BM25-retrieved source chunks to rate each response and rank the advisors — RAG for multi-LLM evals.</p>
      <span class="project-card__cta">View on GitHub <span aria-hidden="true">→</span></span>
    </a>
