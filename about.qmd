...
<section id="work" class="section-block" data-animate aria-labelledby="work-heading">
  ...
  <div class="timeline">
    ...
    <article class="timeline-entry">
      <div class="timeline-entry__header">
        ...
        <div>
          ...
          <p class="timeline-entry__meta">Senior Data Scientist</p>
        </div>
      </div>
    ...
    <article class="timeline-entry">
      <div class="timeline-entry__header">
        ...
        <div>
          ...
          <p class="timeline-entry__meta">Growth Data Scientist</p>
        </div>
      </div>
      <p class="timeline-entry__body">
    ...
    <article class="timeline-entry">
      <div class="timeline-entry__header">
        <img class="timeline-entry__logo" src="img/insaite_logo.png" alt="Insaite" loading="lazy" decoding="async" />
        <div>
          <p class="timeline-entry__company">Insaite <span class="timeline-entry__tag">AI Startup · Mexico</span></p>
          <p class="timeline-entry__meta">Data Science Sales Engineer</p>
        </div>
      </div>
      <p class="timeline-entry__body">
    ...
    <article class="timeline-entry">
      <div class="timeline-entry__header">
        <img class="timeline-entry__logo timeline-entry__logo--dark-bg" src="img/axity_logo.png" alt="Axity" loading="lazy" decoding="async" />
        <div>
          <p class="timeline-entry__company">Axity <span class="timeline-entry__tag">Digital Transformation Consultancy</span></p>
          <p class="timeline-entry__meta">Junior Data Scientist</p>
        </div>
      </div>
      <p class="timeline-entry__body">
...
<section id="education" class="section-block" data-animate aria-labelledby="edu-heading">
  ...
  <div class="edu-list">
    <div class="edu-item">
      <img class="edu-item__logo" src="img/ubc_logo.png" alt="UBC" loading="lazy" decoding="async" />
      <div>
    ...
    <div class="edu-item">
      <img class="edu-item__logo" src="img/MIT_logo.svg" alt="MIT" loading="lazy" decoding="async" />
      <div>
    ...
    <div class="edu-item">
      <img class="edu-item__logo" src="img/unam_logo.svg" alt="UNAM" loading="lazy" decoding="async" />
      <div>
